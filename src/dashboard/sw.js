...
// by `serveDashboardFile` in `src/transport/http/handlers/system.ts`. This means every
...
const PRECACHE = [
  ...
  "./components/subagents.js",
  "./components/files-changed.js",
  "./components/files-changed-bridge.js",
  "./components/references.js",
  "./components/label-strip.js",
  "./components/usage-indicator.js",
  "./components/agent-panel.js",
  "./components/right-panel.js",
  "./modals/debug-modal.js",
  "./components/todo-dock.js",
  "./ui/push-notifications.js",
  "./components/command-history.js",
  "./components/file-browser.js",
  "./ui/notif-sound.js",
  "./components/project-tabs.js",
  "./manifest.json",
  "./icons/icon.svg",
]
